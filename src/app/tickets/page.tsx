        ...
        <div className="container mx-auto px-4 md:px-8 lg:px-16 py-12 md:py-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {ticketTiers.map((ticket) => (
                    <Card key={ticket.id} className={`${ticket.id === 'all-access' ? 'bg-accent text-accent-foreground' : ticket.id === 'party' ? 'bg-secondary text-secondary-foreground' : 'bg-primary text-primary-foreground'} rounded-2xl flex flex-col justify-between items-start p-6 min-h-[200px]`}>
                        <div>
